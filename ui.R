    ...
    tabPanel("Database Explorer",
      ...
      tags$div(
        ...
        tags$head(
          ...
          tags$link(rel="apple-touch-icon", sizes = "57x57", href = "/apple-icon-57x57.png"),
          tags$link(rel="apple-touch-icon", sizes = "60x60", href = "/apple-icon-60x60.png"),
          tags$link(rel="apple-touch-icon", sizes = "72x72", href = "/apple-icon-72x72.png"),
          tags$link(rel="apple-touch-icon", sizes = "76x76", href = "/apple-icon-76x76.png"),
          tags$link(rel="apple-touch-icon", sizes = "114x114", href = "/apple-icon-114x114.png"),
          tags$link(rel="apple-touch-icon", sizes = "120x120", href = "/apple-icon-120x120.png"),
          tags$link(rel="apple-touch-icon", sizes = "144x144", href = "/apple-icon-144x144.png"),
          tags$link(rel="apple-touch-icon", sizes = "152x152", href = "/apple-icon-152x152.png"),
          ...
          tags$link(rel="icon", type="image/png", sizes = "96x96", href = "favicon-96x96.png"),
          tags$link(rel="icon", type="image/png", sizes = "16x16", href = "favicon-16x16.png"),
          tags$link(rel="manifest", href="/manifest.json"),
          tags$meta(name="msapplication-TileColor", content="#ffffff"),
          tags$meta(name="msapplication-TileImage", content="/ms-icon-144x144.png"),
